...
> 3. cp -rf data/local/tmp/testlog.log /storage/8280-8F5B/testlog.log
...
| adb 保存log到文件| adb logcat -s "Factory_log" > name.log |
...
| 抄key 2875P 工具测试订单号 | TR_DHR230539_RD   20240619093605|
...
| GTV（75P）43寸 | RTK  UI | 107       | 108/112 | 109/113   | /      |  1        |
